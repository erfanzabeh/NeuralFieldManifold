# Monkey T | 2007-03-16 | channel 7

Recording ID: `monkeyT_session-y070316009-12_lfp-7`. Selected because it has 198 trials, not because of its decoding performance.
...
| --- | --- |
| Peak power | 0.161541 |
| Peak frequency | 0.171439 |
| Power + frequency | 0.186021 |
| All band powers | 0.225966 |
| K-mode geometry | 0.178774 |
| Geometry + power/frequency | 0.227182 |
| Geometry + all bands | 0.246190 |
...
Median held-out geometric residual SSE/TSS: 0.802081; successful-fit fraction: 1.000000.
...
Selected AR orders in fold order 0-4: 15,18,15,15,15.
Held-out 10-ms recursive AR NMSE: 0.003814; R-squared: 0.996186.
