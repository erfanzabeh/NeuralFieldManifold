# Monkey M | 2008-05-06 | channel 1

Recording ID: `monkeyM_session-o080506002-22_lfp-1`. Selected because it has 198 trials, not because of its decoding performance.
...
| --- | --- |
| Peak power | 0.163233 |
| Peak frequency | 0.143123 |
| Power + frequency | 0.190037 |
| All band powers | 0.219053 |
| K-mode geometry | 0.175143 |
| Geometry + power/frequency | 0.184085 |
| Geometry + all bands | 0.202033 |
...
Median held-out geometric residual SSE/TSS: 0.762616; successful-fit fraction: 1.000000.
...
Selected AR orders in fold order 0-4: 15,15,18,17,15.
Held-out 10-ms recursive AR NMSE: 0.005064; R-squared: 0.994936.
